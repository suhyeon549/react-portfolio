...
`)+`
`+v);const N=L+S+f,I=L+v+h,H=Cg(l,l.VERTEX_SHADER,N),O=Cg(l,l.FRAGMENT_SHADER,I);l.attachShader(A,H),l.attachShader(A,O),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function V(B){if(s.debug.checkShaderErrors){const j=l.getProgramInfoLog(A)||"",ne=l.getShaderInfoLog(H)||"",le=l.getShaderInfoLog(O)||"",ce=j.trim(),F=ne.trim(),q=le.trim();let Y=!0,he=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(Y=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,H,O);else{const U=Ug(l,H,"vertex"),$=Ug(l,O,"fragment");rn("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
