...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ma,depthTest:!1,depthWrite:!1})}function B3(s,e,i){const r=new Float32Array(Cr),l=new de(0,1,0);return new Sa({name:"SphericalGaussianBlur",defines:{n:Cr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/i,CUBEUV_MAX_MIP:`${s}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:l}},vertexShader:su(),fragmentShader:`
...
.contact-info-box-clean {
    ...
    /* 폼 영역을 제거했으므로, 이 박스를 전체 중앙에 배치하도록 조정 */
    /* width를 px로 변경하여 확대/축소 시 크기 고정 */
    max-height: 30rem;
}
